...
exports.ExerciseDoneEvent = void 0;
...
class ExerciseDoneEvent {
    constructor(userId, exercisesId) {
        this.userId = userId;
        this.exercisesId = exercisesId;
    }
}
exports.ExerciseDoneEvent = ExerciseDoneEvent;
events_manager_1.EventsManager.on(ExerciseDoneEvent.name, (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    activity_model_1.Activity.create({
        ...
        related_id: new mongoose_1.Types.ObjectId(event.exercisesId),
        activity_type: activity_type_enum_1.ActivityType.EXERCISE,
    }).catch(console.error);
}));
//# sourceMappingURL=exercise-done.event.js.map