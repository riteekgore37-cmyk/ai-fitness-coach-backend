...
exports.updateTemplatesSchema = void 0;
const joi = __importStar(require("joi"));
const create_schema_1 = require("../../../../../helpers/create-schema");
exports.updateTemplatesSchema = (0, create_schema_1.createSchema)({
    ...
    exercises: joi.array().empty().optional().items(joi.string().empty().optional().messages({
...
//# sourceMappingURL=update-templates.validation.js.map