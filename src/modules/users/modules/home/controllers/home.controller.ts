...
export class homePageController extends BaseController {
  ...
  getHomePageStreak = async (req: IUserRequest, res: Response) => {
    ...
    return JsonResponse.success({ data: serialize(streak, HomeStreakSerialization) }, res);
  };
  ...
  getHomePageYourDailyIntake = async (req: IUserRequest, res: Response) => {
    ...
    return JsonResponse.success({ data: serialize(dailyIntake, UserHomeYourDailyIntakeSerialization) }, res);
  };
  ...
  getHomePageDailyGoals = async (req: IUserRequest, res: Response) => {
    ...
    return JsonResponse.success({ data: serialize(dailyGoals, UserHomeDailyGoalsSerialization) }, res);
  }
  ...
  getHomePage = async (req: IUserRequest, res: Response) => {
    ...
    const myWorkout = await this.userRegisteredWorkoutsService.findOne(
    ...
    const myMealPlan = await this.userRegisteredMealPlansService.findOne(
    ...
    if (myMealPlan) {
      ...
      if (dayToEat) {
        const totalCalories = dayToEat.meals.reduce((sum, meal: any) => sum + (meal?.calories || 0), 0);
    ...
    return JsonResponse.success({ data: serialize(data, HomeSerialization) }, res);
  };
}